%------------------------------------------------------------------------------
% File     : HL401060+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Enumeral_2Enumeral__distrib.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Enumeral_2Enumeral__distrib.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 2448 (1296 unit)
%            Number of atoms       : 5170 (2149 equality)
%            Maximal formula depth :   37 (   5 average)
%            Number of connectives : 2972 ( 250   ~; 270   |; 809   &)
%                                         ( 765 <=>; 878  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    :  772 ( 332 constant; 0-6 arity)
%            Number of variables   : 8139 (  26 sgn;7922   !; 217   ?)
