%------------------------------------------------------------------------------
% File     : HL401198+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Egcd_2EP__EUCLIDES.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Egcd_2EP__EUCLIDES.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 2959 (1596 unit)
%            Number of atoms       : 6136 (2695 equality)
%            Maximal formula depth :   37 (   5 average)
%            Number of connectives : 3468 ( 291   ~; 293   |;1012   &)
%                                         ( 885 <=>; 987  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    :  961 ( 412 constant; 0-6 arity)
%            Number of variables   : 9486 (  26 sgn;9238   !; 248   ?)
