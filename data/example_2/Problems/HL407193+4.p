%------------------------------------------------------------------------------
% File     : HL407193+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal_2EREAL__LT__IMP__LE.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal_2EREAL__LT__IMP__LE.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 27056 (18176 unit)
%            Number of atoms       : 52200 (29674 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 27569 (2425   ~;1440   |;10764   &)
%                                         (6871 <=>;6069  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 10760 (4403 constant; 0-10 arity)
%            Number of variables   : 104733 ( 130 sgn;90940   !;13793   ?)
...
fof(thm_2Ereal_2EREAL__LT__IMP__LE,conjecture,(
    ! [V0x_2E0,V1y_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Erealax_2Ereal__lt_2E2(s(tyop_2Erealax_2Ereal,V0x_2E0),s(tyop_2Erealax_2Ereal,V1y_2E0))))
     => p(s(tyop_2Emin_2Ebool,c_2Ereal_2Ereal__lte_2E2(s(tyop_2Erealax_2Ereal,V0x_2E0),s(tyop_2Erealax_2Ereal,V1y_2E0)))) ) )).
