%------------------------------------------------------------------------------
% File     : HL407216+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal_2EREAL__LT__ADD.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal_2EREAL__LT__ADD.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 27079 (18185 unit)
%            Number of atoms       : 52247 (29682 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 27596 (2428   ~;1443   |;10776   &)
%                                         (6872 <=>;6077  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 10760 (4403 constant; 0-10 arity)
%            Number of variables   : 104777 ( 130 sgn;90984   !;13793   ?)
...
fof(thm_2Ereal_2EREAL__LT__ADD,conjecture,(
    ! [V0x_2E0,V1y_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Erealax_2Ereal__lt_2E2(s(tyop_2Erealax_2Ereal,c_2Ereal_2Ereal__of__num_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0))),s(tyop_2Erealax_2Ereal,V0x_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Erealax_2Ereal__lt_2E2(s(tyop_2Erealax_2Ereal,c_2Ereal_2Ereal__of__num_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0))),s(tyop_2Erealax_2Ereal,V1y_2E0)))) )
