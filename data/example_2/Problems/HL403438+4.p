%------------------------------------------------------------------------------
% File     : HL403438+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2EEncode_2Ebiprefix__append.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2EEncode_2Ebiprefix__append.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 9706 (6275 unit)
%            Number of atoms       : 20608 (11602 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 11609 ( 707   ~; 476   |;4572   &)
%                                         (3334 <=>;2520  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 3803 (1503 constant; 0-6 arity)
%            Number of variables   : 45439 (  67 sgn;32920   !;12519   ?)
...
fof(arityeq2_2Ec_2EEncode_2Ebiprefix_2E2_2Emono_2EA_27a,axiom,(
...
fof(thm_2EEncode_2Ebiprefix__refl,axiom,(
    ! [A_27a,V0x_2E0] : p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),V0x_2E0),s(tyop_2Elist_2Elist(A_27a),V0x_2E0)))) )).

fof(thm_2EEncode_2Ebiprefix__sym,axiom,(
    ! [A_27a,V0x_2E0,V1y_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),V0x_2E0),s(tyop_2Elist_2Elist(A_27a),V1y_2E0))))
     => p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),V1y_2E0),s(tyop_2Elist_2Elist(A_27a),V0x_2E0)))) ) )).

fof(thm_2EEncode_2Ebiprefix__append,conjecture,(
    ! [A_27a,V0a_2E0,V1b_2E0,V2c_2E0,V3d_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V0a_2E0),s(tyop_2Elist_2Elist(A_27a),V1b_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V2c_2E0),s(tyop_2Elist_2Elist(A_27a),V3d_2E0))))))
     => p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),V0a_2E0),s(tyop_2Elist_2Elist(A_27a),V2c_2E0)))) ) )).
