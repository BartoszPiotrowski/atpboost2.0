%------------------------------------------------------------------------------
% File     : HL404524+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ecardinal_2ECARD__LT__CARD.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ecardinal_2ECARD__LT__CARD.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 15742 (10295 unit)
%            Number of atoms       : 31896 (17309 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 17568 (1414   ~; 870   |;6610   &)
%                                         (4858 <=>;3816  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 6874 (2692 constant; 0-6 arity)
%            Number of variables   : 64664 (  75 sgn;51780   !;12884   ?)
...
fof(thm_2Ecardinal_2ECARD__LT__CARD,conjecture,(
    ! [A_27a,A_27b,V0s_2E0,V1t_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1t_2E0)))) )
     => ( ~ p(s(tyop_2Emin_2Ebool,c_2Ecardinal_2Ecardleq_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1t_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0))))
