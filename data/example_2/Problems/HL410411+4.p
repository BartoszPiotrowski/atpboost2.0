%------------------------------------------------------------------------------
% File     : HL410411+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal__topology_2EBILINEAR__SUM__PARTIAL__PRE.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal__topology_2EBILINEAR__SUM__PARTIAL__PRE.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 38381 (25858 unit)
%            Number of atoms       : 72772 (41547 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 38014 (3623   ~;1880   |;15100   &)
%                                         (8421 <=>;8990  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 15588 (6395 constant; 0-10 arity)
%            Number of variables   : 139114 ( 166 sgn;124582   !;14532   ?)
...
fof(thm_2Ereal__topology_2EBILINEAR__SUM__PARTIAL__PRE,conjecture,(
    ! [V0f_2E0,V1g_2E0,V2h_2E0,V3m_2E0,V4n_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Ebilinear_2E1(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Erealax_2Ereal)),V2h_2E0))))
