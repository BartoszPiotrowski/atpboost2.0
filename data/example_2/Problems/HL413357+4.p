%------------------------------------------------------------------------------
% File     : HL413357+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Eextreal_2EEXTREAL__SUM__IMAGE__FINITE__SAME.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Eextreal_2EEXTREAL__SUM__IMAGE__FINITE__SAME.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 34570 (23119 unit)
%            Number of atoms       : 65734 (37914 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 34579 (3415   ~;1847   |;13513   &)
%                                         (8054 <=>;7750  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 13548 (5636 constant; 0-10 arity)
%            Number of variables   : 125488 ( 156 sgn;111163   !;14325   ?)
...
fof(thm_2Eextreal_2EEXTREAL__SUM__IMAGE__FINITE__SAME,conjecture,(
    ! [A_27a,V0s_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0))))
     => ! [V1f_2E0,V2p_2E0] :
