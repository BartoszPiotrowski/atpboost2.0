%------------------------------------------------------------------------------
% File     : HL407153+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal_2EREAL__LT__IADD.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal_2EREAL__LT__IADD.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 27005 (18147 unit)
%            Number of atoms       : 52117 (29625 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 27529 (2417   ~;1435   |;10758   &)
%                                         (6858 <=>;6061  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 10750 (4398 constant; 0-10 arity)
%            Number of variables   : 104632 ( 130 sgn;90843   !;13789   ?)
...
fof(thm_2Ereal_2EREAL__LT__IADD,conjecture,(
    ! [V0x_2E0,V1y_2E0,V2z_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Erealax_2Ereal__lt_2E2(s(tyop_2Erealax_2Ereal,V1y_2E0),s(tyop_2Erealax_2Ereal,V2z_2E0))))
