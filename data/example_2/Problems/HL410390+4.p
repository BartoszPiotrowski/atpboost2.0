%------------------------------------------------------------------------------
% File     : HL410390+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal__topology_2ELINEAR__SUB.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal__topology_2ELINEAR__SUB.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 38322 (25820 unit)
%            Number of atoms       : 72682 (41494 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 37983 (3623   ~;1880   |;15092   &)
%                                         (8420 <=>;8968  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 15556 (6384 constant; 0-10 arity)
%            Number of variables   : 138901 ( 166 sgn;124373   !;14528   ?)
...
fof(thm_2Ereal__topology_2ELINEAR__SUB,conjecture,(
    ! [V0f_2E0,V1x_2E0,V2y_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Elinear_2E1(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Erealax_2Ereal),V0f_2E0))))
