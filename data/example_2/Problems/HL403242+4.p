%------------------------------------------------------------------------------
% File     : HL403242+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ebag_2EBAG__UNION__DIFF__eliminate.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ebag_2EBAG__UNION__DIFF__eliminate.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 10526 (6786 unit)
%            Number of atoms       : 22121 (12281 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 12464 ( 869   ~; 537   |;4823   &)
%                                         (3600 <=>;2635  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 4288 (1688 constant; 0-6 arity)
%            Number of variables   : 47576 (  67 sgn;34991   !;12585   ?)
...
fof(thm_2Ebag_2EBAG__UNION__DIFF__eliminate,conjecture,(
    ! [A_27a,V0c_2E0,V1b_2E0] :
