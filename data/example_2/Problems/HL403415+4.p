%------------------------------------------------------------------------------
% File     : HL403415+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ebag_2EBAG__INTER__FINITE.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ebag_2EBAG__INTER__FINITE.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 10825 (6939 unit)
%            Number of atoms       : 22791 (12548 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 12865 ( 899   ~; 546   |;4958   &)
%                                         (3653 <=>;2809  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 4354 (1715 constant; 0-6 arity)
%            Number of variables   : 48688 (  67 sgn;36083   !;12605   ?)
...
fof(arityeq2_2Ec_2Ebag_2EBAG__INTER_2E2_2Emono_2EA_27a,axiom,(
...
fof(thm_2Ebag_2Edominates__DIFF,axiom,(
    ! [A_27a,V0y_2E0,V1x_2E0,V2i_2E0,V3R_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Erelation_2EWF_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3R_2E0))))
        ...
        & p(s(tyop_2Emin_2Ebool,c_2Ebag_2Edominates_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3R_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0y_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2i_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Epred__set_2ESUBSET_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2i_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1x_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Epred__set_2ESUBSET_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2i_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0y_2E0)))) )
     => p(s(tyop_2Emin_2Ebool,c_2Ebag_2Edominates_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3R_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EDIFF_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2i_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EDIFF_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0y_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2i_2E0)))))) ) )).
...
fof(thm_2Ebag_2EBAG__INTER__SUB__BAG,axiom,(
    ! [A_27a,V0b2_2E0,V1b1_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ebag_2ESUB__BAG_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),c_2Ebag_2EBAG__INTER_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V1b1_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V0b2_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V1b1_2E0))))
      & p(s(tyop_2Emin_2Ebool,c_2Ebag_2ESUB__BAG_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),c_2Ebag_2EBAG__INTER_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V1b1_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V0b2_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V0b2_2E0)))) ) )).

fof(thm_2Ebag_2EBAG__INTER__FINITE,conjecture,(
    ! [A_27a,V0b2_2E0,V1b1_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Ebag_2EFINITE__BAG_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V1b1_2E0))))
