%------------------------------------------------------------------------------
% File     : HL400868+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Earithmetic_2EMOD__TIMES__SUB.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Earithmetic_2EMOD__TIMES__SUB.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 2069 (1119 unit)
%            Number of atoms       : 4300 (1788 equality)
%            Maximal formula depth :   26 (   5 average)
%            Number of connectives : 2468 ( 237   ~; 242   |; 616   &)
%                                         ( 646 <=>; 727  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    :  664 ( 285 constant; 0-6 arity)
%            Number of variables   : 7008 (  26 sgn;6833   !; 175   ?)
