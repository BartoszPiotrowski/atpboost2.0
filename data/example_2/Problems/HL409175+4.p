%------------------------------------------------------------------------------
% File     : HL409175+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal__sigma_2EREAL__SUM__IMAGE__FINITE__CONST.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal__sigma_2EREAL__SUM__IMAGE__FINITE__CONST.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 32826 (21927 unit)
%            Number of atoms       : 62660 (35881 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 32994 (3160   ~;1803   |;12734   &)
%                                         (7915 <=>;7382  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 12980 (5370 constant; 0-10 arity)
%            Number of variables   : 120933 ( 152 sgn;106680   !;14253   ?)
...
fof(thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IF__ELIM,axiom,(
...
fof(thm_2Ereal__sigma_2EREAL__SUM__IMAGE__FINITE__SAME,axiom,(
    ! [A_27a,V0P_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0))))
     => ! [V1f_2E0,V2p_2E0] :
...
fof(thm_2Ereal__sigma_2EREAL__SUM__IMAGE__FINITE__CONST,conjecture,(
    ! [A_27a,V0P_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0))))
     => ! [V1f_2E0,V2x_2E0] :
