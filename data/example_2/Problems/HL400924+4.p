%------------------------------------------------------------------------------
% File     : HL400924+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Earithmetic_2EEXP__BASE__INJECTIVE.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Earithmetic_2EEXP__BASE__INJECTIVE.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 2125 (1122 unit)
%            Number of atoms       : 4464 (1865 equality)
%            Maximal formula depth :   26 (   5 average)
%            Number of connectives : 2578 ( 239   ~; 245   |; 646   &)
%                                         ( 668 <=>; 780  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    :  664 ( 285 constant; 0-6 arity)
%            Number of variables   : 7164 (  26 sgn;6983   !; 181   ?)
