%------------------------------------------------------------------------------
% File     : HL409893+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__LMUL.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__LMUL.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 36047 (24160 unit)
%            Number of atoms       : 68469 (39422 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 35947 (3525   ~;1861   |;14018   &)
%                                         (8202 <=>;8341  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 14393 (5951 constant; 0-10 arity)
%            Number of variables   : 130926 ( 156 sgn;116526   !;14400   ?)
...
fof(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__LMUL,conjecture,(
    ! [V0p_2E0,V1c_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Eiterate_2Epolynomial__function_2E1(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Erealax_2Ereal),V0p_2E0))))
