%------------------------------------------------------------------------------
% File     : HL410386+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal__topology_2ELINEAR__0.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal__topology_2ELINEAR__0.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 38318 (25820 unit)
%            Number of atoms       : 72674 (41490 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 37979 (3623   ~;1880   |;15092   &)
%                                         (8420 <=>;8964  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 15556 (6384 constant; 0-10 arity)
%            Number of variables   : 138890 ( 166 sgn;124362   !;14528   ?)
...
fof(thm_2Ereal__topology_2ELINEAR__0,conjecture,(
    ! [V0f_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Elinear_2E1(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Erealax_2Ereal),V0f_2E0))))
