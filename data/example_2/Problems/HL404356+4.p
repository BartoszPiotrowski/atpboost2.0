%------------------------------------------------------------------------------
% File     : HL404356+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ecardinal_2ESUBSET__CARDLEQ.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ecardinal_2ESUBSET__CARDLEQ.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 15331 (10039 unit)
%            Number of atoms       : 31042 (16941 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 17041 (1330   ~; 855   |;6432   &)
%                                         (4774 <=>;3650  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 6761 (2649 constant; 0-6 arity)
%            Number of variables   : 63088 (  75 sgn;50250   !;12838   ?)
...
fof(thm_2Ecardinal_2ESUBSET__CARDLEQ,conjecture,(
