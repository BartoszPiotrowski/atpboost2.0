%------------------------------------------------------------------------------
% File     : HL410452+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 38446 (25888 unit)
%            Number of atoms       : 72925 (41585 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 38106 (3627   ~;1881   |;15137   &)
%                                         (8426 <=>;9035  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 15602 (6401 constant; 0-10 arity)
%            Number of variables   : 139260 ( 166 sgn;124726   !;14534   ?)
...
fof(thm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF,conjecture,(
    ! [V0s_2E0,V1a_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Esubspace_2E1(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool),V0s_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Erealax_2Ereal,V1a_2E0),s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool),V0s_2E0)))) )
