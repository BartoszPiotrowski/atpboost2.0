%------------------------------------------------------------------------------
% File     : HL402128+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Elist_2EFILTER__EQ__NIL.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Elist_2EFILTER__EQ__NIL.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 4868 (2746 unit)
%            Number of atoms       : 9537 (4484 equality)
%            Maximal formula depth :   37 (   5 average)
%            Number of connectives : 5146 ( 477   ~; 361   |;1496   &)
%                                         (1269 <=>;1543  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 1554 ( 654 constant; 0-6 arity)
%            Number of variables   : 15508 (  28 sgn;15124   !; 384   ?)
...
fof(thm_2Elist_2EFILTER__EQ__NIL,conjecture,(
    ! [A_27a,V0P_2E0,V1l_2E0] :
