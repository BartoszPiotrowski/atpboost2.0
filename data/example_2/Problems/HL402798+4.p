%------------------------------------------------------------------------------
% File     : HL402798+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Erich__list_2EDROP__LASTN.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Erich__list_2EDROP__LASTN.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 8468 (5392 unit)
%            Number of atoms       : 18663 (10350 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 10837 ( 642   ~; 441   |;4356   &)
%                                         (3144 <=>;2254  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 3376 (1330 constant; 0-6 arity)
%            Number of variables   : 40514 (  67 sgn;28032   !;12482   ?)
...
fof(thm_2Erich__list_2EDROP__LASTN,conjecture,(
    ! [A_27a,V0n_2E0,V1l_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Earithmetic_2E_3C_3D_2E2(s(tyop_2Enum_2Enum,V0n_2E0),s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(A_27a),V1l_2E0))))))
