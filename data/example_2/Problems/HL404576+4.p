%------------------------------------------------------------------------------
% File     : HL404576+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Ecardinal_2ECOUNTABLE__IMAGE__INJ.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Ecardinal_2ECOUNTABLE__IMAGE__INJ.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 15876 (10390 unit)
%            Number of atoms       : 32113 (17404 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 17676 (1439   ~; 871   |;6650   &)
%                                         (4864 <=>;3852  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 6903 (2703 constant; 0-6 arity)
%            Number of variables   : 65236 (  75 sgn;52352   !;12884   ?)
...
fof(thm_2Ecardinal_2ECOUNTABLE__IMAGE__INJ,conjecture,(
    ! [A_27a,A_27b,V0f_2E0,V1A_2E0] :
      ( ( ! [V2x_2E0,V3y_2E0] :
            ( s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V2x_2E0))) = s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V3y_2E0)))
           => s(A_27a,V2x_2E0) = s(A_27a,V3y_2E0) )
