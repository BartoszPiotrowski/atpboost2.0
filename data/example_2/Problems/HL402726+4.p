%------------------------------------------------------------------------------
% File     : HL402726+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Erich__list_2ECOMM__ASSOC__FOLDL__REVERSE.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Erich__list_2ECOMM__ASSOC__FOLDL__REVERSE.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 8376 (5354 unit)
%            Number of atoms       : 18501 (10272 equality)
%            Maximal formula depth :  360 (   5 average)
%            Number of connectives : 10761 ( 636   ~; 441   |;4353   &)
%                                         (3144 <=>;2187  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    : 3376 (1330 constant; 0-6 arity)
%            Number of variables   : 40205 (  67 sgn;27723   !;12482   ?)
...
fof(thm_2Erich__list_2ECOMM__ASSOC__FOLDL__REVERSE,conjecture,(
    ! [A_27a,V0f_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ecombin_2ECOMM_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0))))
     => ( p(s(tyop_2Emin_2Ebool,c_2Ecombin_2EASSOC_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0))))
