%------------------------------------------------------------------------------
% File     : HL400529+4 : TPTP v7.4.0. Released v7.4.0.
% Domain   : HOL4
% Problem  : HOL4 syntactic export of thm_2Eoption_2EOPTION__CHOICE__EQ__NONE.p, chainy mode
...
% Source   : [BG+19]
% Names    : thm_2Eoption_2EOPTION__CHOICE__EQ__NONE.p [Gau20]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    : 1379 ( 709 unit)
%            Number of atoms       : 3121 (1122 equality)
%            Maximal formula depth :   26 (   5 average)
%            Number of connectives : 1930 ( 188   ~; 191   |; 474   &)
%                                         ( 486 <=>; 591  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 1-2 arity)
%            Number of functors    :  457 ( 200 constant; 0-4 arity)
%            Number of variables   : 4776 (  26 sgn;4661   !; 115   ?)
...
fof(thm_2Eoption_2EOPTION__CHOICE__def,axiom,(
    ! [A_27a] :
      ( ! [V0m2_2E0] : s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2EOPTION__CHOICE_2E2(s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ENONE_2E0),s(tyop_2Eoption_2Eoption(A_27a),V0m2_2E0))) = s(tyop_2Eoption_2Eoption(A_27a),V0m2_2E0)
      & ! [V1x_2E0,V2m2_2E0] : s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2EOPTION__CHOICE_2E2(s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ESOME_2E1(s(A_27a,V1x_2E0))),s(tyop_2Eoption_2Eoption(A_27a),V2m2_2E0))) = s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ESOME_2E1(s(A_27a,V1x_2E0))) ) )).
...
fof(thm_2Eoption_2EOPTION__GUARD__COND,axiom,(
...
fof(thm_2Eoption_2EOPTION__GUARD__EQ__THM,axiom,(
    ! [V0b_2E0] :
      ( ( s(tyop_2Eoption_2Eoption(tyop_2Eone_2Eone),c_2Eoption_2EOPTION__GUARD_2E1(s(tyop_2Emin_2Ebool,V0b_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Eone_2Eone),c_2Eoption_2ESOME_2E1(s(tyop_2Eone_2Eone,c_2Eone_2Eone_2E0)))
      <=> p(s(tyop_2Emin_2Ebool,V0b_2E0)) )
      & ( s(tyop_2Eoption_2Eoption(tyop_2Eone_2Eone),c_2Eoption_2EOPTION__GUARD_2E1(s(tyop_2Emin_2Ebool,V0b_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Eone_2Eone),c_2Eoption_2ENONE_2E0)
      <=> ~ p(s(tyop_2Emin_2Ebool,V0b_2E0)) ) ) )).

fof(thm_2Eoption_2EOPTION__CHOICE__EQ__NONE,conjecture,(
    ! [A_27a,V0m2_2E0,V1m1_2E0] :
