...
class GraphHyperEdgesAPH:
    def __init__(self):
        with tf.name_scope("GraphHyperEdgesA"):
            ...
            self.symbols = tf.placeholder(tf.int32, [None], name="symbols")
            self.nodes = tf.placeholder(tf.int32, [None,2], name="nodes")
            self.sgn = tf.placeholder(tf.float32, [None], name="sgn")
...
class GraphHyperEdgesBPH:
    def __init__(self):
        with tf.name_scope("GraphHyperEdgesB"):
            ...
            self.nodes = tf.placeholder(tf.int32, [None,3], name="nodes")
            self.sgn = tf.placeholder(tf.float32, [None], name="sgn")
...
class GraphEdgesPH:
    def __init__(self, nonzero = False):
        with tf.name_scope("GraphEdges"):
            ...
            self.data = tf.placeholder(tf.int32, [None], name="data")
...
class GraphPlaceholder():
    def __init__(self):
        with tf.name_scope("GraphPlaceholder"):
            ...
            self.ini_nodes = tf.placeholder(tf.int32, [None], name="ini_nodes")
            self.ini_symbols = tf.placeholder(tf.int32, [None], name="ini_symbols")
            self.ini_clauses = tf.placeholder(tf.int32, [None], name="ini_clauses")
            ...
            self.axiom_mask = tf.placeholder(tf.int32, [None], name="axiom_mask")
