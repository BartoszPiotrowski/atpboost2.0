...
int main(int argc, char **argv)
{
  ...
  value *ml_print_symbols = caml_named_value("cop_print_symbols");

  //const char *fname = "../tst-problematic2/t1_jordan1b";
  char *fname = argv[1];
  caml_callback(*ml_start, caml_copy_string(fname));
  caml_callback(*ml_print_symbols, Val_unit);
}
